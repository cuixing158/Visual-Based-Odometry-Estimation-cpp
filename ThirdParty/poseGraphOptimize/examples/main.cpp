...
int main(int, char **)
{
  ...
  main_poseGraphOptimize();

  poseGraphOptimize::poseGraphOptimize_terminate();
  return 0;
}

void main_poseGraphOptimize()
{
  coder::array<double, 2U> absposes_tmp;
  coder::array<double, 2U> loopNodePairs;
  coder::array<double, 2U> updatedPoses;

  absposes_tmp = argInit_Unboundedx3_real_T();

  loopNodePairs = argInit_Unboundedx2_real_T();

  poseGraphOptimize::poseGraphOptimize(absposes_tmp, loopNodePairs,
                                       absposes_tmp, updatedPoses);
}
